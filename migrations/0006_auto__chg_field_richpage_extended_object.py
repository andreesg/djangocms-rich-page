...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RichPage.extended_object'
        db.alter_column(u'rich_page_richpage', 'extended_object_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.Title'], unique=True))

    def backwards(self, orm):

        # Changing field 'RichPage.extended_object'
        db.alter_column(u'rich_page_richpage', 'extended_object_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.Page'], unique=True))
