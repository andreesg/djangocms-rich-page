...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rich_page_richslideshow', (
            ...
            ('title', self.gf('django.db.models.fields.CharField')(default='Slideshow title', max_length=100)),
        ))
        db.send_create_signal(u'rich_page', ['RichSlideshow'])

        # Adding field 'RichPage.slideshow'
        db.add_column(u'rich_page_richpage', 'slideshow',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='richpage_slideshow_placeholder', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RichPage.slideshow'
        db.delete_column(u'rich_page_richpage', 'slideshow_id')
    ...
    models = {
        ...
        u'rich_page.richpage': {
            ...
            'slideshow': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'richpage_slideshow_placeholder'", 'null': 'True', 'to': "orm['cms.Placeholder']"})
        },
