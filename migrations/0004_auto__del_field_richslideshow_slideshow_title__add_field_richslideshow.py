...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RichSlideshow.slideshow_title'
        db.delete_column(u'rich_page_richslideshow', 'slideshow_title')

        # Adding field 'RichSlideshow.title'
        db.add_column(u'rich_page_richslideshow', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Slideshow title', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RichSlideshow.slideshow_title'
        db.add_column(u'rich_page_richslideshow', 'slideshow_title',
                      self.gf('django.db.models.fields.CharField')(default='Slideshow title', max_length=100),
                      keep_default=False)

        # Deleting field 'RichSlideshow.title'
        db.delete_column(u'rich_page_richslideshow', 'title')
    ...
    models = {
        ...
        u'rich_page.richpage': {
            ...
            'slideshow': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Placeholder']", 'null': 'True'})
        },
        u'rich_page.richslideshow': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'Slideshow title'", 'max_length': '100'})
        },
        u'sites.site': {
